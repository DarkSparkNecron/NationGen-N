...
public class ArgTest {
	@Test
	public void testLex() {
		ArgParser parser = Args.parse("one two \"three four\" five (six and 7) 8 'nine \"ten\"' \"'eleven twelve' 13\"");
	...
	public void testNestedQuotes() {
		...
		ArgParser zero = Args.parse("zero 'one \"two \\'three \\\\\"four \\\\\\\\\\'five\\\\\\\\\\' four\\\\\" three\\' two\" one' zero");
	...
	public void testParentheses() {
		...
		Assert.assertTrue(parser.next("parenthesis").getParenthesis().get(0).isParenthesis());
